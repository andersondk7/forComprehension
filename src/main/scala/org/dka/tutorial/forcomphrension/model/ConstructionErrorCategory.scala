...
case object BadInput extends ConstructionErrorCategory { override val number: Int = 300 }
case object BuilderError extends ConstructionErrorCategory { override val number: Int = 500 }
